      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-4 py-20 pt-32">
        <div className="flex flex-wrap">
          <div className="relative mb-10 w-full lg:mb-0 lg:mr-20 lg:w-2/5">
            ...
            <img
              className="relative z-20 h-full w-full rounded object-cover"
          ...
          <div className="flex-1 pl-0 lg:pl-4">
            <div className="mb-12">
              <div className="relative">
                <h1 className="absolute -left-44 -top-14 hidden font-bold opacity-5 sm:block sm:text-[120px]">
                  {" "}
                  FEATURE
                </h1>
            ...
            <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
              <div className="700 w-full rounded bg-background p-8 text-center shadow transition-all hover:shadow-lg">
                <div className="mb-4 inline-block rounded-full bg-orange-400 p-4">
                  <svg
              ...
              <div className="w-full rounded bg-background p-8 text-center shadow transition-all hover:shadow-lg ">
                <div className="mb-4 inline-block rounded-full bg-orange-400 p-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={30}
