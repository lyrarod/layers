export function About() {
  return (
    ...
    >
      <div className="mx-auto max-w-6xl pt-32 md:px-6 lg:py-6">
        <div className="flex flex-wrap ">
          <div className="mb-10 w-full px-4 lg:mb-0 lg:w-1/2 ">
            <div className="lg:max-w-md">
              <div className="mb-6 border-l-4 border-orange-500 px-4 pl-4">
              ...
              <p className="mb-10 px-4 text-base leading-7 text-gray-500 dark:text-gray-400">
              ...
              <div className="flex flex-wrap items-center">
                <div className="mb-6 w-full px-4 sm:w-1/2 md:w-1/2 lg:mb-6">
                  <div className="bg-secondary p-6 ">
                    ...
                    <p className="mb-2 mt-4 text-3xl font-bold text-gray-700 dark:text-gray-400">
                      2097
                    </p>
          ...
          <div className="mb-10 w-full px-4 lg:mb-0 lg:w-1/2">
            <img
              ...
              alt=""
              className="relative z-40 h-full w-full rounded object-cover"
            />
          </div>
        </div>
      </div>
