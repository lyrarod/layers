    ...
    >
      <div className="mx-auto max-w-7xl px-4 pb-10 pt-32">
        ...
        <div className="grid grid-cols-1 gap-x-4 gap-y-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-8">
          <div className="mb-5 w-full rounded bg-secondary p-8 text-center shadow transition-all hover:shadow-lg">
            <div className="-mt-16 mb-6 inline-block rounded-full bg-orange-400 p-4">
              <svg
